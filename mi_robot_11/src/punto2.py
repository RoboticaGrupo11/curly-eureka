...
from turtle_bot_11.srv import save_route_srv, replay_tour_srv
from PIL import ImageGrab
from tkinter import filedialog


PATH_BACKGROUND = rospkg.RosPack().get_path('turtle_bot_11')+'/resources/Background3.png'

PATH_RESOURCES= rospkg.RosPack().get_path('turtle_bot_11')+'/resources/'
...
class Punto2:
    ...
    def callback_drawLine(self, odom_data):
        ...
        posx = pose.x*self.sizeImg/5 + self.sizeImg/2
        posy = pose.y*-self.sizeImg/5 + self.sizeImg/2
